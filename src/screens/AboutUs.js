    ...
    >
      ...
      <View style={{ padding: "5%" }}>
        ...
        <Text style={externalStyle.tutorial_title}>Origins</Text>{"\n"}
          Better Future was created with the intention of educating and 
          teaching ethical investing. The program was developed by a group 
          of students from Western Washington University as part of their 
          CSCI 436 - 'Technology for the Social Good' curriculum.{"\n"}
        </Text>
        <Text>
        <Text style={externalStyle.tutorial_title}>Sources</Text>{"\n"}
          The ESG data located within the application is sourced from 
          Sustainalytics, and the stock price data is accessed 
        ...
        <Text style={externalStyle.tutorial_title}>Contact Information</Text>{"\n"}
          Please contact us with inquiries and 
          bug reports at: NotAnEmailAddress@fix.this. 
        </Text>
      </View>
    </ScrollView>
  );
